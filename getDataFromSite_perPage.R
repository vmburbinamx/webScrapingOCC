...
# Build data frame
allTheData <- bind_cols(jobTitles, companyNames, theLocations, theSalary, theDescription)
# remove individual data frames
remove(jobTitles, companyNames, theLocations, theSalary, htmlContent, theClasses, theDescription)
