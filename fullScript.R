...
# ---URL & KEYWORD ("google%20data%20studio")-------------------------------------------------------------------------
# Define a key word
...
# keyWord <- "sales%20administration"
# keyWord <- "advanced%20excel%20skills"
...
# ---URL & KEYWORD ("advanced%20excel%20skills")-------------------------------------------------------------------------
# Define a key word
# keyWord <- "google%20data%20studio"
# keyWord <- "access"
# keyWord <- "Tableau"
